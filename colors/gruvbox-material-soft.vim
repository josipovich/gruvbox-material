...
" Last Updated: Fri 09 Aug 2019 02:19:49 PM CST
...
hi! link rstDirective Red
hi! link rstTableLines Grey
hi! link rstEscapeInlineLiteral Yellow
...
hi! link QuickmenuNumber Yellow
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  if get(g:, 'gruvbox_material_enable_bold', 0)
    hi Error guifg=#ea6962 guibg=#32302f guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi Function guifg=#a9b665 guibg=NONE guisp=NONE gui=bold cterm=bold
  else
    hi Error guifg=#ea6962 guibg=#32302f guisp=NONE gui=reverse cterm=reverse
  ...
  hi rstSections guifg=#e78a4e guibg=NONE guisp=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  if get(g:, 'gruvbox_material_enable_bold', 0)
    hi Error ctermfg=167 ctermbg=236 cterm=bold,reverse
  ...
  hi rstSections ctermfg=208 ctermbg=NONE cterm=bold
...
if s:t_Co >= 8
  ...
  hi rstSections ctermfg=DarkYellow ctermbg=NONE cterm=bold
