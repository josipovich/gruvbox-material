...
" Last Updated: Tue 03 Sep 2019 06:24:02 PM CST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  let g:terminal_ansi_colors = ['#bdae93', '#c52424', '#6f7a34', '#c35800',
        \ '#38747c', '#94597e', '#487a5b', '#764e37', '#928374', '#c52424',
        \ '#6f7a34', '#b67715', '#38747c', '#94597e', '#487a5b', '#764e37']
  if has('nvim')
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
      hi DiffAdd ctermfg=NONE ctermbg=58 cterm=NONE
      hi DiffChange ctermfg=NONE ctermbg=236 cterm=NONE
      hi DiffDelete ctermfg=NONE ctermbg=52 cterm=NONE
      hi Error ctermfg=NONE ctermbg=52 cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
...
" Color: darkgreen_hard   #32361a         ~               DarkGreen
" Color: darkred_hard     #3c1f1e         ~               DarkRed
" Color: darkblue_hard    #0d3138         ~               DarkBlue
" Color: darkgreen_medium #34381b         ~               DarkGreen
" Color: darkred_medium   #402120         ~               DarkRed
" Color: darkblue_medium  #0e363e         ~               DarkBlue
" Color: darkgreen_soft   #3d4220         ~               DarkGreen
" Color: darkred_soft     #472322         ~               DarkRed
" Color: darkblue_soft    #0f3a42         ~               DarkBlue
