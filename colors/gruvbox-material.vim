...
" Last Updated: Sun 22 Sep 2019 07:03:33 PM CST
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      hi SignifySignAdd ctermfg=142 ctermbg=236 cterm=NONE
      hi SignifySignChange ctermfg=109 ctermbg=236 cterm=NONE
      hi SignifySignDelete ctermfg=167 ctermbg=236 cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
    ...
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
      hi SyntasticErrorSign ctermfg=167 ctermbg=236 cterm=NONE
      hi SyntasticWarningSign ctermfg=214 ctermbg=236 cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft'
    ...
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'soft' 
      hi BufTabLineFill ctermfg=236 ctermbg=236 cterm=NONE
    elseif get(g:, 'gruvbox_material_background', 'medium') ==# 'medium'
